(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.kennedi, 300, 180, 7, 0, 8);
        collectable.create(type.grace, 400, 190, 8, 0, 9);
        collectable.create(type.steve, 500, 200, 9, 0, 10);
        collectable.create(type.kennedi,600, 210, 10, 0, 11);
